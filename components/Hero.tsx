 ...
 * the "Some places sweat more than others." statement in the second. Runs
...
export default function Hero() {
  return (
    <section id="top" className="relative mx-3 overflow-hidden rounded-3xl sm:mx-5">
      {/* single continuous image behind both copy sections; copy is nested
          inside HeroReveal so pointer events over the text still reach the
      ...
      >
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 -z-10 bg-[linear-gradient(to_bottom,rgba(29,28,26,0.1),rgba(29,28,26,0.38)_46%,rgba(29,28,26,0.2)_66%,rgba(29,28,26,0.42))]"
        />
